...
START_DATE = os.getenv("START_DATE", default="2025-01-29") # Default: Season 2 start date
END_DATE = os.getenv("END_DATE", default=dt.datetime.now().strftime("%Y-%m-%d")) # Set in .env file, or defaults to today
