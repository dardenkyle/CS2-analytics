...
- `ResultsScraper` still performs discovery-time queue insertion into `match_ingestion_state`
...
- Current code uses names like `match_ingestion_state` and `map_ingestion_state`
